...
/**
 * Member 2 Learning Module for SDG 3: Good Health and Well-being.
 * Provides at least 10 educational screens with text and generated Java2D images.
 *
 * Creator: Member 2 (Learning module + educational content)
 * Tester:
 */
public class LearningModule implements Learning {
    ...
    private BufferedImage createVisualImage(String visualCode, int width, int height) {
        ...
        if ("maternal".equals(visualCode)) {
            ...
            g2.setColor(COLOR_SDG_GREEN);
            g2.drawLine(45, 95, 85, 95);
            g2.drawLine(85, 95, 105, 55);
            g2.drawLine(105, 55, 135, 115);
            g2.drawLine(135, 115, 160, 75);
            g2.drawLine(160, 75, 250, 75);
            g2.setColor(Color.WHITE);
            ...
            g2.setColor(COLOR_SDG_GREEN);
            g2.drawOval(75, 35, 90, 85);
            g2.drawArc(95, 65, 45, 35, 200, 140);
            g2.setColor(Color.WHITE);
            ...
            g2.setColor(COLOR_SDG_GREEN);
            g2.drawOval(70, 30, 110, 110);
            g2.drawLine(125, 30, 125, 140);
            g2.drawLine(70, 85, 180, 85);
            g2.setColor(Color.WHITE);
            ...
            g2.setColor(COLOR_SDG_GREEN);
            g2.drawOval(75, 32, 110, 110);
            g2.drawLine(130, 35, 130, 140);
            g2.drawLine(80, 88, 180, 88);
            g2.setColor(Color.WHITE);
            g2.drawString("Health for All", 86, 125);
        }
