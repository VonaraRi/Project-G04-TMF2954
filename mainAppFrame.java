...
public class mainAppFrame extends JFrame {
    ...
    private JPanel createDashboardPanel() {
        ...
        gridModules.add(btnModule1);
        gridModules.add(btnModule2);
        gridModules.add(btnModule3);
        gridModules.add(btnModule4);
        gridModules.add(btnModule5);
        gridModules.add(btnModule6);
    ...
    private JButton createModuleCard(String indexNum, String textTitle) {
        ...
        JLabel lblTitle = new JLabel(
                "<html><body style='color:#ffffff; font-family:Arial; font-size:11px; font-weight:bold;'>"
                        + textTitle.replace("\n", "<br>")
                        + "</body></html>"
        );
